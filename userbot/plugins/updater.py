...
OFFICIAL_UPSTREAM_REPO = "https://github.com/NikhilNGY/SimbhaUserbot"
BOT_IS_UP_TO_DATE = "Simbha Userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**Simbha Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**The Latest Branch** `Master` **Has Been Pushed To Heroku** \n**Now Trying A Restart To Complete Updation Process ⚠️ Wait 5 Minutes, !!** To Check If I am Alive Just Do `.alive` or `.help` !!!! Thank For Using Simbha Userbot Service (◍•ᴗ•◍)💖")
